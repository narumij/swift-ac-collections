...
- non optional ポインタで組まれているので、CのNULLは未初期化以外では混入しない。
...
- 異なる木が絡む場合、外部由来の未チェックポインタが使われていないか。
- BoundRange は実ポインタを持っていないので、ポインタ付きRangeと錯覚しないようにしよう
- Deprecated 系は意図的に除外して見ている。
