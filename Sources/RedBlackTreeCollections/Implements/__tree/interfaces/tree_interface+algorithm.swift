...
//  func __tree_sub_invariant(_ __x: _NodePtr) -> UInt
  ...
  @inlinable func __tree_min(_ __x: _NodePtr) -> _NodePtr
  @inlinable func __tree_max(_ __x: _NodePtr) -> _NodePtr
  @inlinable func __tree_next(_ __x: _NodePtr) -> _NodePtr
  @inlinable func __tree_next_iter(_ __x: _NodePtr) -> _NodePtr
  @inlinable func __tree_prev_iter(_ __x: _NodePtr) -> _NodePtr
  @inlinable func __tree_leaf(_ __x: _NodePtr) -> _NodePtr
}
...
protocol TreeAlgorithmInterface: _NodePtrType {
  ...
  @inlinable func __tree_remove(_ __root: _NodePtr, _ __z: _NodePtr)
}
