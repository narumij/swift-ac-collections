...
extension RedBlackTreeIteratorUnsafe {
...
extension RedBlackTreeIteratorUnsafe.KeyValues where Base: KeyValueComparer {

  #if COMPATIBLE_ATCODER_2025
    /// - Complexity: O(1)
    @inlinable
    @inline(__always)
    public func keys() -> RedBlackTreeIteratorUnsafe<Base>.Keys {
    ...
    @inlinable
    @inline(__always)
    public func values() -> RedBlackTreeIteratorUnsafe<Base>.MappedValues {
      .init(tree: __tree_, start: _start, end: _end)
    }
  #else
    /// - Complexity: O(1)
    @inlinable
    @inline(__always)
    public var keys: RedBlackTreeIteratorUnsafe<Base>.Keys {
      .init(tree: __tree_, start: _start, end: _end)
    }
    ...
    @inlinable
    @inline(__always)
    public var values: RedBlackTreeIteratorUnsafe<Base>.MappedValues {
      .init(tree: __tree_, start: _start, end: _end)
    }
  #endif
}

extension RedBlackTreeIteratorUnsafe.KeyValues: Equatable
...
extension RedBlackTreeIteratorUnsafe.KeyValues: Comparable
...
#if swift(>=5.5)
  extension RedBlackTreeIteratorUnsafe.KeyValues: @unchecked Sendable
  where Tree._Value: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeIteratorUnsafe.KeyValues: ___UnsafeIsIdenticalTo {}
