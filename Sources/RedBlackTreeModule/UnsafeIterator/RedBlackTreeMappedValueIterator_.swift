...
extension RedBlackTreeIteratorUnsafe.MappedValues: Equatable where Base._MappedValue: Equatable {
...
extension RedBlackTreeIteratorUnsafe.MappedValues: Comparable where Base._MappedValue: Comparable {
...
#if swift(>=5.5)
  extension RedBlackTreeIteratorUnsafe.MappedValues: @unchecked Sendable
  where Tree._Value: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeIteratorUnsafe.MappedValues: ___UnsafeIsIdenticalTo {}
