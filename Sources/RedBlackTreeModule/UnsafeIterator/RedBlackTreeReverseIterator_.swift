...
extension RedBlackTreeIteratorUnsafe.Values {
...
extension RedBlackTreeIteratorUnsafe.Values.Reversed {
...
extension RedBlackTreeIteratorUnsafe.Values.Reversed: Equatable where Element: Equatable {
...
extension RedBlackTreeIteratorUnsafe.Values.Reversed: Comparable where Element: Comparable {
...
#if swift(>=5.5)
  extension RedBlackTreeIteratorUnsafe.Values.Reversed: @unchecked Sendable
  where Tree._Value: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeIteratorUnsafe.Values.Reversed: ___UnsafeIsIdenticalTo {}
