...
extension RedBlackTreeIteratorUnsafe.Keys {
...
extension RedBlackTreeIteratorUnsafe.Keys.Reversed: Equatable {
...
extension RedBlackTreeIteratorUnsafe.Keys.Reversed: Comparable {
...
#if swift(>=5.5)
  extension RedBlackTreeIteratorUnsafe.Keys.Reversed: @unchecked Sendable
  where Tree._Value: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeIteratorUnsafe.Keys.Reversed: ___UnsafeIsIdenticalTo {}
