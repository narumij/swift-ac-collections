...
extension RedBlackTreeIteratorUnsafe.KeyValues {
...
extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed {
...
extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed {
  ...
  @inlinable
  @inline(__always)
  public var indices: UnsafeIndices<Base>.Reversed {
    .init(tree: __tree_, start: _start, end: _end)
  }
}

extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed where Base: KeyValueComparer {

  #if COMPATIBLE_ATCODER_2025
    /// - Complexity: O(1)
    @inlinable
    @inline(__always)
    public func keys() -> RedBlackTreeIteratorUnsafe<Base>.Keys.Reversed {
      .init(tree: __tree_, start: _start, end: _end)
    }
    ...
    @inlinable
    @inline(__always)
    public func values() -> RedBlackTreeIteratorUnsafe<Base>.MappedValues.Reversed {
      .init(tree: __tree_, start: _start, end: _end)
    }
  #else
    /// - Complexity: O(1)
    @inlinable
    @inline(__always)
    public var keys: RedBlackTreeIteratorUnsafe<Base>.Keys.Reversed {
      .init(tree: __tree_, start: _start, end: _end)
    }
    ...
    @inlinable
    @inline(__always)
    public var values: RedBlackTreeIteratorUnsafe<Base>.MappedValues.Reversed {
      .init(tree: __tree_, start: _start, end: _end)
    }
  #endif
}
...
extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed {
  ...
  @inlinable
  @inline(__always)
  package func ___node_positions() -> ___SafePointersUnsafe<Base>.Reversed {
    .init(tree: __tree_, start: _start, end: _end)
  }
}

extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed: Equatable
...
extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed: Comparable
...
#if swift(>=5.5)
  extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed: @unchecked Sendable
  where Tree._Value: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeIteratorUnsafe.KeyValues.Reversed: ___UnsafeIsIdenticalTo {}
