...
extension RedBlackTreeSliceUnsafe {

  @frozen
  public struct KeyValue: ___UnsafeCommon & ___UnsafeSubSequence & ___UnsafeIndex & ___UnsafeKeyValueSequence
  where
...
extension RedBlackTreeSliceUnsafe.KeyValue: Sequence & Collection & BidirectionalCollection {}

extension RedBlackTreeSliceUnsafe.KeyValue {
...
extension RedBlackTreeSliceUnsafe.KeyValue {
  ...
  public typealias Keys = RedBlackTreeIteratorUnsafe<Base>.Keys
  public typealias Values = RedBlackTreeIteratorUnsafe<Base>.MappedValues
...
extension RedBlackTreeSliceUnsafe.KeyValue where _Key: Equatable, _MappedValue: Equatable {
...
extension RedBlackTreeSliceUnsafe.KeyValue where _Key: Comparable, _MappedValue: Comparable {
...
extension RedBlackTreeSliceUnsafe.KeyValue: Equatable where _Key: Equatable, _MappedValue: Equatable {
...
extension RedBlackTreeSliceUnsafe.KeyValue: Comparable where _Key: Comparable, _MappedValue: Comparable {
...
#if swift(>=5.5)
  extension RedBlackTreeSliceUnsafe.KeyValue: @unchecked Sendable
  where Element: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeSliceUnsafe.KeyValue: ___UnsafeIsIdenticalTo {}
