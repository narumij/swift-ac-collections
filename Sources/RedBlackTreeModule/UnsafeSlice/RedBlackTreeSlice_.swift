...
@frozen
public struct RedBlackTreeSliceUnsafe<Base>: ___UnsafeCommon & ___UnsafeSubSequence & ___UnsafeIndex &  ___UnsafeKeyOnlySequence where Base: ___TreeBase & ___TreeIndex {
...
extension RedBlackTreeSliceUnsafe: Sequence & Collection & BidirectionalCollection {}
...
extension RedBlackTreeSliceUnsafe where _Value: Equatable {
...
extension RedBlackTreeSliceUnsafe where _Value: Comparable {
...
extension RedBlackTreeSliceUnsafe: Equatable where _Value: Equatable {
...
extension RedBlackTreeSliceUnsafe: Comparable where _Value: Comparable {
...
#if swift(>=5.5)
  extension RedBlackTreeSliceUnsafe: @unchecked Sendable
  where Element: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeSliceUnsafe: ___UnsafeIsIdenticalTo {}
