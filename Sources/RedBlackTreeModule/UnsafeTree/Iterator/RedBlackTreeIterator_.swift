...
@frozen
public enum RedBlackTreeIteratorUnsafe<Base> where Base: ___TreeBase & ___TreeIndex {
...
extension RedBlackTreeIteratorUnsafe.Values: Equatable where Tree._Value: Equatable {
...
extension RedBlackTreeIteratorUnsafe.Values: Comparable where Tree._Value: Comparable {
...
#if swift(>=5.5)
  extension RedBlackTreeIteratorUnsafe.Values: @unchecked Sendable
  where Tree._Value: Sendable {}
#endif

// MARK: - Is Identical To

extension RedBlackTreeIteratorUnsafe.Values: ___UnsafeIsIdenticalTo {}
