...
extension UnsafeTree where Base._Key == Base._Value {
  ...
  internal static func
    create_unique(sorted elements: __owned [Base._Value]) -> UnsafeTree
...
extension UnsafeTree where Base: KeyValueComparer & ___UnsafeKeyValueSequence {
...
extension UnsafeTree {
  ...
  @inline(__always)
  internal static func
    create_multi(sorted elements: __owned [Base._Value]) -> UnsafeTree
  where Base._Key: Comparable {
...
extension UnsafeTree {
  ...
  /// - Complexity: O(*n*)
  @inlinable
  internal static func create<R>(range: __owned R) -> UnsafeTree
...
extension UnsafeTree {
  ...
  @inlinable
  internal static func create_unique<S>(naive sequence: __owned S) -> UnsafeTree
  ...
  @inlinable
  internal static func create_multi<S>(naive sequence: __owned S) -> UnsafeTree
  where Base._Value == S.Element, S: Sequence {
...
extension UnsafeTree where _Value: Decodable {

  @inlinable
  internal static func create(from decoder: Decoder) throws -> UnsafeTree {
