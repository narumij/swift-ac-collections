...
extension UnsafeTree: Equatable where _Value: Equatable {

  @inlinable
  @inline(__always)
  public static func == (lhs: UnsafeTree<Base>, rhs: UnsafeTree<Base>) -> Bool {
...
extension UnsafeTree: Comparable where _Value: Comparable {
