...
extension UnsafeTree {
  ...
  internal static func ___insert_range_unique<Other>(
    tree __tree_: UnsafeTree,
    other __source: UnsafeTree<Other>,
    _ __first: _NodePtr,
    _ __last: _NodePtr
  ) -> UnsafeTree
  where
...
extension UnsafeTree {
  ...
  @inlinable
  internal static func ___insert_range_unique<S>(tree __tree_: UnsafeTree, _ __source: __owned S)
    -> UnsafeTree
...
extension UnsafeTree {
  ...
  internal static func
    ___insert_range_multi<S>(tree __tree_: UnsafeTree, _ __source: __owned S) -> UnsafeTree
  where Base._Value == S.Element, S: Sequence {
