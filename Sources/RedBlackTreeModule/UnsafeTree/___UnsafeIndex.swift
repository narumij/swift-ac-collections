...
@usableFromInline
protocol ___UnsafeIndex: ___UnsafeBase {}

extension ___UnsafeIndex {
...
extension ___UnsafeIndex where Self: Collection {
...
extension ___UnsafeIndex where Base: CompareUniqueTrait {
...
extension ___UnsafeIndex where Base: CompareMultiTrait {
