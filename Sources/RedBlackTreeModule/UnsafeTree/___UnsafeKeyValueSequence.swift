...
@usableFromInline
protocol ___UnsafeKeyValueSequence: ___UnsafeBase, ___TreeIndex
where
...
extension ___UnsafeKeyValueSequence {
...
extension ___UnsafeKeyValueSequence where Self: ___UnsafeCommon {
...
extension ___UnsafeKeyValueSequence where Self: ___UnsafeBaseSequence {
...
extension ___UnsafeKeyValueSequence where Self: ___UnsafeIndex {
