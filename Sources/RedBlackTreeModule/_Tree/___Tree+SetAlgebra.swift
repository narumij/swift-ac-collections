...
extension ___Tree {
  ...
  @inlinable
  @inline(__always)
  final internal func ___copy_range(_ f: inout _NodePtr, _ l: _NodePtr, to r: inout Tree) {
  ...
  @inlinable
  @inline(__always)
  final internal func ___meld_unique(_ other: ___Tree) -> ___Tree {
  ...
  @inlinable
  @inline(__always)
  final internal func ___meld_multi(_ other: ___Tree) -> ___Tree {
  ...
  @inlinable
  @inline(__always)
  final internal func ___intersection(_ other: ___Tree) -> ___Tree {
  ...
  @inlinable
  @inline(__always)
  final internal func ___symmetric_difference(_ other: ___Tree) -> ___Tree {
    var __result_: ___Tree = .create(minimumCapacity: 0)
    var (__parent, __child) = __result_.___max_ref()
    var (__first1, __last1) = (__begin_node_, __end_node())
    var (__first2, __last2) = (other.__begin_node_, other.__end_node())
  ...
  @inlinable
  @inline(__always)
  final internal func ___difference(_ other: ___Tree) -> ___Tree {
    var __result_: ___Tree = .create(minimumCapacity: 0)
    var (__parent, __child) = __result_.___max_ref()
    var (__first1, __last1) = (__begin_node_, __end_node())
    var (__first2, __last2) = (other.__begin_node_, other.__end_node())
