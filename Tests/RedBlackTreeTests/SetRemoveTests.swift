...
final class SetRemoveTests: XCTestCase {
  ...
  func testRemove() throws {
    ...
    func testRemoveAt() throws {
      XCTAssertEqual(members.___remove(at: members._tree_.__begin_node), 0)
      XCTAssertEqual(members.elements, [1, 2, 3, 4])
      XCTAssertEqual(members.count, 4)
      XCTAssertEqual(members.___remove(at: members._tree_.__begin_node), 1)
      XCTAssertEqual(members.elements, [2, 3, 4])
      XCTAssertEqual(members.count, 3)
      XCTAssertEqual(members.___remove(at: members._tree_.__begin_node), 2)
      XCTAssertEqual(members.elements, [3, 4])
      XCTAssertEqual(members.count, 2)
      XCTAssertEqual(members.___remove(at: members._tree_.__begin_node), 3)
      XCTAssertEqual(members.elements, [4])
      XCTAssertEqual(members.count, 1)
      XCTAssertEqual(members.___remove(at: members._tree_.__begin_node), 4)
      XCTAssertEqual(members.elements, [])
      XCTAssertEqual(members.count, 0)
      XCTAssertEqual(members.___remove(at: members._tree_.__begin_node), nil)
    }
  #endif
