...
final class SetRemoveTests: RedBlackTreeTestCase {
  ...
  func testRemove() throws {
    ...
    func testRemoveAt() throws {
      XCTAssertEqual(members.___remove(at: members.__tree_.__begin_node_)?.payload, 0)
      XCTAssertEqual(members.elements, [1, 2, 3, 4])
      XCTAssertEqual(members.count, 4)
      XCTAssertEqual(members.___remove(at: members.__tree_.__begin_node_)?.payload, 1)
      XCTAssertEqual(members.elements, [2, 3, 4])
      XCTAssertEqual(members.count, 3)
      XCTAssertEqual(members.___remove(at: members.__tree_.__begin_node_)?.payload, 2)
      XCTAssertEqual(members.elements, [3, 4])
      XCTAssertEqual(members.count, 2)
      XCTAssertEqual(members.___remove(at: members.__tree_.__begin_node_)?.payload, 3)
      XCTAssertEqual(members.elements, [4])
      XCTAssertEqual(members.count, 1)
      XCTAssertEqual(members.___remove(at: members.__tree_.__begin_node_)?.payload, 4)
      XCTAssertEqual(members.elements, [])
      XCTAssertEqual(members.count, 0)
      XCTAssertEqual(members.___remove(at: members.__tree_.__begin_node_)?.payload, nil)
    }
  #endif
