...
import XCTest
  ...
  extension RedBlackTreeSet {
    ...
    var __nodes: [___Node] {
      get {
        (0..<_tree_._header.initializedCount).map {
          .init(__is_black_: _tree_.__is_black_($0),
                __left_: _tree_.__left_($0),
                __right_: _tree_.__right_($0),
                __parent_: _tree_.__parent_($0))
        }
      }
      set {
        _tree_.___clearDestroy()
        _tree_._header.initializedCount = newValue.count
        newValue.enumerated().forEach {
          i, v in
          _tree_.__is_black_(i, v.__is_black_)
          _tree_.__left_(i, v.__left_)
          _tree_.__right_(i, v.__right_)
          _tree_.__parent_(i, v.__parent_)
        }
      }
    }
  ...
  final class ___RedBlackTreeContainerTests: XCTestCase {
    ...
    func testRootInvaliant() throws {
      ...
      tree.__root(.nullptr)
      XCTAssertFalse(tree._tree_.__tree_invariant(0))

      tree.__root(0)
      XCTAssertTrue(tree._tree_.__tree_invariant(tree.__root()))
#endif
      ...
      XCTAssertFalse(tree._tree_.__tree_invariant(tree.__root()))
    ...
    func testBalancing0() throws {
      ...
      XCTAssertNotEqual(tree._tree_.__parent_(tree.__root()), nil)
    ...
    func testRemove3() throws {
      ...
      _ = tree._tree_.__insert_unique(0)
      _ = tree._tree_.__insert_unique(1)
      _ = tree._tree_.__insert_unique(2)
      XCTAssertEqual(tree._tree_.__tree_min(tree._tree_.__root()), tree.___header.__begin_node)
      for i in 0..<3 {
        _ = tree._tree_.___erase_unique(i)
    ...
    func testRemove2() throws {
      ...
      let tree = RedBlackTreeSet<Int>(minimumCapacity: capacity)
      for i in 0..<2 {
        _ = tree._tree_.__insert_unique(i)
      }
      //        fixture0_1_2_3_4_5_6(&tree)
      XCTAssertEqual(tree._tree_.__tree_min(tree._tree_.__root()), tree.___header.__begin_node)
      for i in 0..<2 {
        XCTAssertTrue(tree._tree_.___erase_unique(i), "i = \(i)")
        print("__root():", tree.__root())
        XCTAssertTrue(tree.___tree_invariant())
        XCTAssertEqual(
          tree.__root() == .nullptr ? .end : tree._tree_.__tree_min(tree._tree_.__root()),
    ...
    func testFindEqual0() throws {
      ...
      do {
        ...
        let __k = 5
        let __child = tree._tree_.__find_equal(&__parent, __k)
    ...
    func testInsert0() throws {
      ...
      //      fixtureEmpty(&tree)
      for i in 0..<10000 {
        XCTAssertTrue(tree._tree_.__insert_unique(i).__inserted)
      }
      XCTAssertTrue(tree.___tree_invariant())
    }
